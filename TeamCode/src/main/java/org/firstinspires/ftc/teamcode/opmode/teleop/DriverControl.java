...
//            }
            ...
            if(currDriver.left_trigger >= 0.20) {
                ...
                intake.deactivateIntake(RobotConstants.HardwareConfiguration.kLabelIntakeServoRight);
            }
...
//            }
            ...
            if(currOperator.left_bumper) {
                indexer.activateIndexer(RobotConstants.HardwareConfiguration.kLabelIndexServoRight, -1.0);
            }
            ...
            if(currOperator.left_trigger >= 0.20 || currOperator.right_trigger >= 0.20) {
...
//            telemetry.addData("light mode", sysLighting.getLightPatternCurrent().toString());
            ...
            telemetry.addData("power"
                    , String.format(Locale.US,"{left: %.3f, Right: %.3f}"
                            , intake.getIntakePower(RobotConstants.HardwareConfiguration.kLabelIntakeServoLeft)
